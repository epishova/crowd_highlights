...
Meteor.startup(
  function() {
      ...
      if (exp3AB.find().count() < 228) {
/*
          exp3AB.insert({idRandom: 1, idB: "", idA: "QPGLyPxgNMu4NnbYp"});
          exp3AB.insert({idRandom: 2, idB: "", idA: "oXQjefM4pZvK42G6G"});
          exp3AB.insert({idRandom: 3, idB: "", idA: "pY8624xpNxSLCZoFC"});
          exp3AB.insert({idRandom: 4, idB: "", idA: "hpDewxycnSXRNWdk4"});
          exp3AB.insert({idRandom: 5, idB: "", idA: "ixqYsHJzA2zzvJKq6"});
          exp3AB.insert({idRandom: 6, idB: "", idA: "5GchYNALwRg6NEnAP"});
          exp3AB.insert({idRandom: 7, idB: "", idA: "eAvT8EZvjGsNXJTKM"});
          exp3AB.insert({idRandom: 8, idB: "", idA: "oJT7cRstwaDCENr8w"});
          exp3AB.insert({idRandom: 9, idB: "", idA: "u6qi8Q2aJerK4kjG9"});
          exp3AB.insert({idRandom: 10, idB: "", idA: "o6Q8Notfv2HApizyA"});
          exp3AB.insert({idRandom: 11, idB: "", idA: "fb5iYDGeGKk46ok4P"});
          exp3AB.insert({idRandom: 12, idB: "", idA: "XiYYcSiJe6Dy26Lsp"});
          exp3AB.insert({idRandom: 13, idB: "", idA: "QpQFKiPHjXGfqxKKQ"});
          exp3AB.insert({idRandom: 14, idB: "", idA: "aSXFLfEayvP8F6yYC"});
          exp3AB.insert({idRandom: 15, idB: "", idA: "uNQtkHmaHxKdwJgJv"});
          exp3AB.insert({idRandom: 16, idB: "", idA: "WN7BhTLdbiGpgEko2"});
          exp3AB.insert({idRandom: 17, idB: "", idA: "snnCpze7fphRWR4rz"});
          exp3AB.insert({idRandom: 18, idB: "", idA: "M5sZM6DThx94YP5pm"});
          exp3AB.insert({idRandom: 19, idB: "", idA: "hLjTuZtj4x3njiWJo"});
          exp3AB.insert({idRandom: 20, idB: "", idA: "DYZfduDBbe2JhMF3e"});
              exp3AB.insert({idRandom: 21, idB: "", idA: "hKnMegi6bRG7qcLLF"});
              exp3AB.insert({idRandom: 22, idB: "", idA: "WP2jTdzPJa975L7hz"});
              exp3AB.insert({idRandom: 23, idB: "", idA: "PJ4XARPEz5uSbqmgM"});
              exp3AB.insert({idRandom: 24, idB: "", idA: "vJJ85BTnTE9ujhAxD"});
              exp3AB.insert({idRandom: 25, idB: "", idA: "iaP6iZs2PKsJNNgbY"});
              exp3AB.insert({idRandom: 26, idB: "", idA: "cqbXq6P2wZ6LX62gY"});
              exp3AB.insert({idRandom: 27, idB: "", idA: "sXAP5spm5Mfe9kLe7"});
              exp3AB.insert({idRandom: 28, idB: "", idA: "xsBBK9PT3KTjhrQEL"});
              exp3AB.insert({idRandom: 29, idB: "", idA: "Jc9g3KSs2KMXP4TTJ"});
              exp3AB.insert({idRandom: 30, idB: "", idA: "eif2qmsFkaxz42MZD"});
              exp3AB.insert({idRandom: 31, idB: "", idA: "AjByiZN88F3mGbxeb"});
              exp3AB.insert({idRandom: 32, idB: "", idA: "vrgEd2MDATkSpXHPP"});
              exp3AB.insert({idRandom: 33, idB: "", idA: "xQtrEMwYgppfZ4o6p"});
              exp3AB.insert({idRandom: 34, idB: "", idA: "6azqB7p2QZRa3Jk7j"});
              exp3AB.insert({idRandom: 35, idB: "", idA: "nFRbiRpoGBbTQDh5Q"});
              exp3AB.insert({idRandom: 36, idB: "", idA: "ABWgKyJtguqJpzXBf"});
              exp3AB.insert({idRandom: 37, idB: "", idA: "gaxL4Zt8aEZ2tCPsa"});
              exp3AB.insert({idRandom: 38, idB: "", idA: "pHFf22Jv5sBfqG44m"});
              exp3AB.insert({idRandom: 39, idB: "", idA: "2pFPTnQtHr8xLSgyd"});
              exp3AB.insert({idRandom: 40, idB: "", idA: "6x9ydtdB9LddPyweh"});
          exp3AB.insert({idRandom: 41, idB: "", idA: "DqAAYC3HhHvnfLGaT"});
          exp3AB.insert({idRandom: 42, idB: "", idA: "DQztF4x6Q3jfHvEyP"});
          exp3AB.insert({idRandom: 43, idB: "", idA: "6RtjTLjGqrPtTxknt"});
          exp3AB.insert({idRandom: 44, idB: "", idA: "5QLKH2SCuMpuaPRSo"});
          exp3AB.insert({idRandom: 45, idB: "", idA: "GRRdBFMEGfJHxGgrx"});
          exp3AB.insert({idRandom: 46, idB: "", idA: "WE9E7GoDYHe8ekfim"});
          exp3AB.insert({idRandom: 47, idB: "", idA: "YJi73udhTMyzNMuBv"});
          exp3AB.insert({idRandom: 48, idB: "", idA: "DPe22Tw4z8fydowXt"});
          exp3AB.insert({idRandom: 49, idB: "", idA: "jSuE5AujzvcZRPkCz"});
          exp3AB.insert({idRandom: 50, idB: "", idA: "NyLAGL3CoKLPrGHbx"});
          exp3AB.insert({idRandom: 51, idB: "", idA: "9zPXMA4HNYzhKu9wr"});
          exp3AB.insert({idRandom: 52, idB: "", idA: "fGMrkWkEGY546vNJs"});
          exp3AB.insert({idRandom: 53, idB: "", idA: "dZvkqKWCwDizrFpbG"});
          exp3AB.insert({idRandom: 54, idB: "", idA: "BnzTvv7qk3unnqkDT"});
          exp3AB.insert({idRandom: 55, idB: "", idA: "pMnc7nBTcwKH7Rv43"});
          exp3AB.insert({idRandom: 56, idB: "", idA: "PpCz2tujJBABnNbhi"});
          exp3AB.insert({idRandom: 57, idB: "", idA: "rAg7hhXLpXo7buHRp"});
          exp3AB.insert({idRandom: 58, idB: "", idA: "LpDBvi74szEQ6aNPE"});
          exp3AB.insert({idRandom: 59, idB: "", idA: "aw5XajyPsWhEEsP7S"});
          exp3AB.insert({idRandom: 60, idB: "", idA: "MZHbpNptYWCpz6ryo"});
          exp3AB.insert({idRandom: 61, idB: "", idA: "P9NhX45ufCi5BR4v3"});
          exp3AB.insert({idRandom: 62, idB: "", idA: "wdKToNGzRXu6Br4Ga"});
          exp3AB.insert({idRandom: 63, idB: "", idA: "rKBprs4EZLFThidcs"});
          exp3AB.insert({idRandom: 64, idB: "", idA: "gQrbQEJnuEJEno73s"});
          exp3AB.insert({idRandom: 65, idB: "", idA: "egdbgRjKKsikRAcfx"});

          exp3AB.insert({idRandom: 66, idB: "", idA: "iqEHkrfSMbscDfpAc"});
          exp3AB.insert({idRandom: 67, idB: "", idA: "wXbxPpQpECeN5Szpm"});
          exp3AB.insert({idRandom: 68, idB: "", idA: "B4p9ePdrcGdGxM5BT"});
          exp3AB.insert({idRandom: 69, idB: "", idA: "a8Zw59aYqePDuep5x"});
          exp3AB.insert({idRandom: 70, idB: "", idA: "4tZFyKCQNQS999Bad"});
          exp3AB.insert({idRandom: 71, idB: "", idA: "a8YoweTfwCGbkZiMz"});
          exp3AB.insert({idRandom: 72, idB: "", idA: "hnK9cK59jJLKd8n8m"});
          exp3AB.insert({idRandom: 73, idB: "", idA: "JXGfntTgGpXRG2EDY"});
          exp3AB.insert({idRandom: 74, idB: "", idA: "PpbxCZBGShguJCK77"});
          exp3AB.insert({idRandom: 75, idB: "", idA: "wZQo36nbMDyCwR5xB"});
          exp3AB.insert({idRandom: 76, idB: "", idA: "SfvrC2cCu98fTkiHX"});
          exp3AB.insert({idRandom: 77, idB: "", idA: "HT7xZAwyb8CNDAdb2"});
          exp3AB.insert({idRandom: 78, idB: "", idA: "P4ELXEvQbrCTF6X8t"});
          exp3AB.insert({idRandom: 79, idB: "", idA: "wrzASFTJLyLNBLtzZ"});
          exp3AB.insert({idRandom: 80, idB: "", idA: "ta3qgJGyeheWD4TSd"});
          exp3AB.insert({idRandom: 81, idB: "", idA: "My2LdD3TK9KWARJwL"});
          exp3AB.insert({idRandom: 82, idB: "", idA: "KNxZGnKWfeoq84BW7"});
          exp3AB.insert({idRandom: 83, idB: "", idA: "MXSyyXkhCMiikNahR"});
          exp3AB.insert({idRandom: 84, idB: "", idA: "Ffx4B68mcvnw2jrbM"});
          exp3AB.insert({idRandom: 85, idB: "", idA: "9n9xfaodqtb349AKS"});
          exp3AB.insert({idRandom: 86, idB: "", idA: "JcT7jEc7y3qijjYqx"});
          exp3AB.insert({idRandom: 87, idB: "", idA: "oLDqF25QokuuLz5y7"});

          exp3AB.insert({idRandom: 88, idB: "", idA: "wprZnpDmuukPn6MBk"});
          exp3AB.insert({idRandom: 89, idB: "", idA: "QE5WtY9LYuRH3ch45"});

          exp3AB.insert({idRandom: 90, idB: "", idA: "wrfdk6gd8sLj3Tkai"});
          exp3AB.insert({idRandom: 91, idB: "", idA: "dYafY5E7bXxSNnuKh"});
          exp3AB.insert({idRandom: 92, idB: "", idA: "5oj4iwxrKYBSumcwk"});
          exp3AB.insert({idRandom: 93, idB: "", idA: "pHWw28JHqyfnz3n4b"});
          exp3AB.insert({idRandom: 94, idB: "", idA: "NNcmJNuzjtbi9bdkk"});
          exp3AB.insert({idRandom: 95, idB: "", idA: "eEjLv2bGKvQCisdpC"});
          exp3AB.insert({idRandom: 96, idB: "", idA: "jeSkoosMLmiRm4uGb"});
          exp3AB.insert({idRandom: 97, idB: "", idA: "cG4hxdXvcMEmPnQhB"});
          exp3AB.insert({idRandom: 98, idB: "", idA: "pHWw28JHqyfnz3n4b"});
          exp3AB.insert({idRandom: 99, idB: "", idA: "wrfdk6gd8sLj3Tkai"});
          exp3AB.insert({idRandom: 100, idB: "", idA: "NNcmJNuzjtbi9bdkk"});
          exp3AB.insert({idRandom: 101, idB: "", idA: "eEjLv2bGKvQCisdpC"});
          exp3AB.insert({idRandom: 102, idB: "", idA: "jeSkoosMLmiRm4uGb"});
          exp3AB.insert({idRandom: 103, idB: "", idA: "cG4hxdXvcMEmPnQhB"});
          exp3AB.insert({idRandom: 104, idB: "", idA: "5oj4iwxrKYBSumcwk"});
          exp3AB.insert({idRandom: 105, idB: "", idA: "dYafY5E7bXxSNnuKh"});

          exp3AB.insert({idRandom: 162, idB: "", idA: "w74Qw7fG7dgDN3a6X"});
          exp3AB.insert({idRandom: 163, idB: "", idA: "sBshaFt4QZJGEgPXN"});
          exp3AB.insert({idRandom: 164, idB: "", idA: "B2W5N2DdfcShsXmyP"});
          exp3AB.insert({idRandom: 165, idB: "", idA: "SQemEWykN2TkzaS3o"});
          exp3AB.insert({idRandom: 166, idB: "", idA: "oiaS4Mg2zGyz4fSWk"});
          exp3AB.insert({idRandom: 167, idB: "", idA: "WPFiM9a6oNMoKvrdm"});
          exp3AB.insert({idRandom: 168, idB: "", idA: "TJapRhT64SAs869ES"});
          exp3AB.insert({idRandom: 169, idB: "", idA: "cH4fLLJY2hhNvsHqd"});
          exp3AB.insert({idRandom: 170, idB: "", idA: "sGrCtbXhuL6dShBFD"});
          exp3AB.insert({idRandom: 171, idB: "", idA: "4hddLnRmDBGCcmgxS"});
          exp3AB.insert({idRandom: 172, idB: "", idA: "WNKHM6AijpiABXWPN"});
          exp3AB.insert({idRandom: 173, idB: "", idA: "WN7HHu5tpuDKjxMWa"});
          exp3AB.insert({idRandom: 174, idB: "", idA: "dy8zPLrZqJZZGuozK"});
          exp3AB.insert({idRandom: 175, idB: "", idA: "WcCT8eSWF2Ws5jBYe"});
          exp3AB.insert({idRandom: 176, idB: "", idA: "mWRFGiHqyiQLHNCks"});
          exp3AB.insert({idRandom: 177, idB: "", idA: "fsLc9PeiJ8ykbggEc"});
          exp3AB.insert({idRandom: 178, idB: "", idA: "jeNranb3mjxytnYNy"});
          exp3AB.insert({idRandom: 179, idB: "", idA: "F8kE398F8XbEDY5W6"});
          exp3AB.insert({idRandom: 180, idB: "", idA: "dd5Mg4sadY6aeA6No"});
          exp3AB.insert({idRandom: 181, idB: "", idA: "fpLJDuzKFWjFXuWaE"});
          exp3AB.insert({idRandom: 182, idB: "", idA: "bertFWXpbsigSFXdr"});
          exp3AB.insert({idRandom: 183, idB: "", idA: "gY9hCSdytF3My4rpN"});
          exp3AB.insert({idRandom: 184, idB: "", idA: "AX64u2BGL4y6eCdD4"});
          exp3AB.insert({idRandom: 185, idB: "", idA: "Mn8BXaMvTWjEbin4H"});
          exp3AB.insert({idRandom: 186, idB: "", idA: "3mwrQ5S5hJRfymSHR"});
          exp3AB.insert({idRandom: 187, idB: "", idA: "dBeqnzCcTCSgFoQ58"});
          exp3AB.insert({idRandom: 188, idB: "", idA: "4TeSrz77aQMTQ2coq"});
          exp3AB.insert({idRandom: 189, idB: "", idA: "XHSHG6vSE5wojdsbt"});
          exp3AB.insert({idRandom: 190, idB: "", idA: "LD7CFbLR8w9pnSkbf"});
          exp3AB.insert({idRandom: 191, idB: "", idA: "K87tS7zd62BZKpr4C"});
          exp3AB.insert({idRandom: 192, idB: "", idA: "6b5XTK99jKWtGR4R6"});
          exp3AB.insert({idRandom: 193, idB: "", idA: "CKo4ggZLS9D7xPZ7q"});
          exp3AB.insert({idRandom: 194, idB: "", idA: "k6mujD26mbZanFg49"});
          exp3AB.insert({idRandom: 195, idB: "", idA: "MJzfMk4vY3SrndWNY"});
          exp3AB.insert({idRandom: 196, idB: "", idA: "Grztz9u76EkmtyHqw"});
          exp3AB.insert({idRandom: 197, idB: "", idA: "ke9iBwBvo6p66dXHJ"});
          exp3AB.insert({idRandom: 198, idB: "", idA: "HBTCoyJdg8EGFpmXi"});
          exp3AB.insert({idRandom: 199, idB: "", idA: "un47fPEQRvxQ89iCC"});
          exp3AB.insert({idRandom: 200, idB: "", idA: "ni69KpGW8u2JNJniA"});
          exp3AB.insert({idRandom: 201, idB: "", idA: "Smv6yfwW5mhrxjCeZ"});
          exp3AB.insert({idRandom: 202, idB: "", idA: "iYW584BuTRy782YgB"});
          exp3AB.insert({idRandom: 203, idB: "", idA: "WhvhMX6XsrZSNmfeJ"});
          exp3AB.insert({idRandom: 204, idB: "", idA: "fTazPBGQhNBNHNikj"});
          exp3AB.insert({idRandom: 205, idB: "", idA: "ru5uEKSzWQ9cXq2se"});
          exp3AB.insert({idRandom: 206, idB: "", idA: "xf552jZiTftLHZj4W"});
          exp3AB.insert({idRandom: 207, idB: "", idA: "sFuh2GhAXncxrpqmk"});
          exp3AB.insert({idRandom: 208, idB: "", idA: "2mL6Qes5J4ZGZoPGB"});
*/
          exp3AB.insert({idRandom: 209, idB: "", idA: "vQNYDwDx6CAGTBoCw"});
          exp3AB.insert({idRandom: 210, idB: "", idA: "h3xhJnp83aG7c5QiZ"});
          exp3AB.insert({idRandom: 211, idB: "", idA: "sE8jC5wzhLxrbSS4o"});
          exp3AB.insert({idRandom: 212, idB: "", idA: "JW2nWcxb56Wg7AuBe"});
          exp3AB.insert({idRandom: 213, idB: "", idA: "gn7ECDgCeYhBcpNyt"});
          exp3AB.insert({idRandom: 214, idB: "", idA: "X6nyhb42C8cXzquDm"});
          exp3AB.insert({idRandom: 215, idB: "", idA: "kpkGaCLX4EW5swrwh"});
          exp3AB.insert({idRandom: 216, idB: "", idA: "vphH5dAKzc35T6gjj"});
          exp3AB.insert({idRandom: 217, idB: "", idA: "MYMWtfuuDGXhFHFM6"});
          exp3AB.insert({idRandom: 218, idB: "", idA: "xYwJv48XGEvZmMRYf"});
          exp3AB.insert({idRandom: 219, idB: "", idA: "aqjwTp7tSexXh2Sao"});
          exp3AB.insert({idRandom: 220, idB: "", idA: "t3PhetYAZzEc6sMTm"});
          exp3AB.insert({idRandom: 221, idB: "", idA: "d5jtQwZdvTSvbYvCp"});
          exp3AB.insert({idRandom: 222, idB: "", idA: "e5EjbXeuur4QDm97X"});
          exp3AB.insert({idRandom: 223, idB: "", idA: "vRtBBswXBhTPpci83"});
          exp3AB.insert({idRandom: 224, idB: "", idA: "qD72bXyCJS99XcB4W"});
          exp3AB.insert({idRandom: 225, idB: "", idA: "BurW8Fj65bAPL4Sqh"});
          exp3AB.insert({idRandom: 226, idB: "", idA: "jDFEtmjW3E4WqPer6"});
          exp3AB.insert({idRandom: 227, idB: "", idA: "W2ofzJkR52WZqakb4"});
          exp3AB.insert({idRandom: 228, idB: "", idA: "t5DxmQuPptYjcGFcN"});
...
TurkServer.initialize(function() {
    ...
    if (randExp == "2" || randExp == "3A") {
        ...
        var expTab = exp3AB.findOne({idRandom: Math.floor(Math.random() * 20) + 209});
        for (var i = 0; i < 25; i++) {
            if (expTab && expTab.idB == "")
                break;
            expTab = exp3AB.findOne({idRandom: Math.floor(Math.random() * 20) + 209});
        }
        for (var i = 209; i <= 228; i++) {
            if (expTab && expTab.idB == "")
                break;
